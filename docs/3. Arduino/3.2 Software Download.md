...
4. If no new ports appear after connecting to the motherboard, please replace the data cable and try a different USB port on the computer. Should the issue persist, refer to the "**Driver installation**" section to install the driver.
![](media/A14.png)
